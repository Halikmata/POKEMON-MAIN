...
from cardquest.views import HomePageView, TrainerList, PokemonCard, Collection, TrainerCreateView
...
urlpatterns = [
    ...
    path('pokemoncard_list', views.PokemonCard.as_view(), name='pokemoncard-list'),  
